...
int main(void)
{
    ...
    //keep running the loop while there are numbers on the card
    while (card_number != 0)
    {
        //Get the last digit
        ...
        if (count_digits % 2 != 0)
        {
            ...
            //If the multiplication gets 2 digits then sum the digits
        ...
        //Eliminate the last digit from the card number then increment the count
